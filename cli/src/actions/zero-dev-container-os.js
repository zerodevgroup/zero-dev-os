  ...
  exec() {
    let promise = new Promise((resolve, reject) => {
      ...
      setTimeout(() => {
        ...
        this.utils.shell(`/snap/bin/lxc exec ${this.options.containerName} -- /opt/zero-dev-os/zero-dev-os install --core`)
        this.utils.shell(`/snap/bin/lxc exec ${this.options.containerName} -- /opt/zero-dev-os/zero-dev-os install --limit-swap`)
        this.utils.shell(`/snap/bin/lxc exec ${this.options.containerName} -- /opt/zero-dev-os/zero-dev-os install --bashrc`)
        this.utils.shell(`/snap/bin/lxc exec ${this.options.containerName} -- /opt/zero-dev-os/zero-dev-os install --vimrc`)
