...
Download Ubuntu Server 20.04.1 64-bit for Raspberry Pi 4
...
### Zip Image
```
zip -r ubuntu-20.04.1-preinstalled-server-arm64+raspi.zip ubuntu-20.04.1-preinstalled-server-arm64+raspi.img
```
